...
//    }
    ...
    public static Message sendMail(String recipient) throws Exception {
        ...
        String email = "tuanconghuynh.hutech@gmail.com";
        //xhvitnnifhxwdwpw
        String password = "xcmhhecojqpygnah";
    ...
    public static Message prepareMessage(Session session, String email, String recipient) throws Exception {
        ...
        message.setSubject("THITRACNGHIEM - XÁC NHẬN TÀI KHOẢN");
    ...
    public static void main(String args[]) throws Exception{
        sendMail("tuanconghuynh.hutech@gmail.com");
    }
